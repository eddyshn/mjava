...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements client.HelloWorldService {
    ...
    public client.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            client.HelloWorldSoapBindingStub _stub = new client.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (client.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                client.HelloWorldSoapBindingStub _stub = new client.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
